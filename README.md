...
Sessions are a simple way to store data for individual users against a unique session ID. Cookies allow us verify a session without sending around a user's password.
